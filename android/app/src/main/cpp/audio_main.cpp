...
JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab2_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass, jint);
JNIEXPORT void JNICALL
        Java_com_ece420_lab2_MainActivity_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_com_ece420_lab2_MainActivity_createAudioRecorder(JNIEnv *env, jclass type, jint);
JNIEXPORT void JNICALL
...
JNIEXPORT jboolean JNICALL
Java_com_ece420_lab2_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type, jint noise) {
    ...
    engine.player_ = new AudioPlayer(&sampleFormat, engine.slEngineItf_, noise);
...
JNIEXPORT jboolean JNICALL
Java_com_ece420_lab2_MainActivity_createAudioRecorder(JNIEnv *env, jclass type, jint noise) {
    SampleFormat sampleFormat;
    memset(&sampleFormat, 0, sizeof(sampleFormat));
    ...
    sampleFormat.sampleRate_ = engine.fastPathSampleRate_;
    sampleFormat.framesPerBuf_ = engine.fastPathFramesPerBuf_;
    engine.recorder_ = new AudioRecorder(&sampleFormat, engine.slEngineItf_, noise);
    if(!engine.recorder_) {
        return JNI_FALSE;
    }
